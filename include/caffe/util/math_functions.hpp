...
// added @ 2016-3-14
template <typename Dtype>
void caffe_clip(const int N, Dtype* X);

// added @ 2016-3-16
template <typename Dtype>
void caffe_quantize(const int N, const Dtype left, const Dtype right, const Dtype* X, Dtype* Y);

    
/*## 我写的量化公式 start ---- ####################################################################*/
// added 
template <typename Dtype>
void caffe_cpu_multi_bit_quantization(const int n, const int bit_width, const Dtype* X, Dtype* Y);
...
// added @ 2016-3-21
template <typename Dtype>
void caffe_cpu_ternary(const int n, const Dtype delta, const Dtype* X, Dtype* Y);
...
// added @ 2016-3-16
template <typename Dtype>
void caffe_gpu_quantize(const int N, const Dtype left, const Dtype right, const Dtype* X, Dtype* Y);

template <typename Dtype>
void caffe_gpu_acmean(const int N, const Dtype* X, Dtype* ret);
...
// added @ 2016-3-21
template<typename Dtype>
void caffe_gpu_ternary(const int n, const Dtype delta, const Dtype* X, Dtype* Y);
